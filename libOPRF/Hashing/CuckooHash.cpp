...
namespace osuCrypto
{
    ...
    CuckooParams k2n07s40CuckooParams
	{ { 1.5,0.17 },{ 3,2 },{ 27,64 } };
    ...
    void CuckooHash::init(u64 n, u64 theirN, u64 opt)
    {
       ...
       // if (statSecParam != 40) throw std::runtime_error("not implemented");
			...
			if (n <= 1 << 7)
				mParams = k2n07s40CuckooParams;			
			else if (n <= 1 << 8)
				mParams = k2n08s40CuckooParams;
			else if (n <= 1 << 12)
				mParams = k2n12s40CuckooParams;
			else if (n <= 1 << 14)
				mParams = k2n14s40CuckooParams;
			else if (n <= 1 << 16)
				mParams = k2n16s40CuckooParams;
			else if (n <= 1 << 20)
				mParams = k2n20s40CuckooParams;
			else if (n <= 1 << 24)
				mParams = k2n24s40CuckooParams;
			else
