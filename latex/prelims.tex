...
\framebox{
    \begin{minipage}{0.95\linewidth}
        ...
        \medskip
				   On input $n$ pairs $\{ (x_1, p_1), \ldots, (x_{n}, p_{n}) \}$, $\hat{p}$ from the sender 
				(where $x_i \in \{0,1\}^*$ are all distinct and $p_i, \hat{p} \in \{0,1\}^\ell$), \\
				...
				\begin{itemize}
					...
					\item Otherwise give output $(n,\hat{p})$ to the receiver.
				\end{itemize}
...
\begin{figure}[htb]\centering
	\framebox{
		\begin{minipage}{0.95\linewidth}
			...
			\medskip
			On input $n$ pairs $\{ (x_1, p_1), \ldots, (x_{n}, p_{n}) \}$, $m$ strings $\{ \hat{p_1}, \ldots, \hat{p_m} \}$ from the sender 
			(where $x_i \in \{0,1\}^*$,$\hat{p_i} \in \{0,1\}^\ell$ are all distinct, and $p_i \in \{0,1\}^\ell$), \\
			...
			\begin{itemize}
				...
				\item Otherwise give output $(n,\hat{p_j})$ to the receiver.
			\end{itemize}
			\end{itemize}
